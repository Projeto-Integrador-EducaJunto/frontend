...
function Sobre() {
    return (
        <div className="w-full h-full flex flex-col p-10 bg-white">

            <h2 className="text-center text-4xl text-blue-500 font-bold py-5 mx-20 my-10 bg-blue-50 rounded-lg shadow">
                Sobre o EducaJunto
            </h2>
            <div className="text-justify text-xl mx-20 mb-10">
                <p className="my-4">
            ...
            <div className="flex flex-wrap justify-center items-center mx-20 my-10 gap-10">
