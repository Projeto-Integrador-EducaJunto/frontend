...
function BuscarTemaNome() {
    ...
    async function BuscarTemaNome() {
        try {
            await buscar(`/temas/nome/${search}`, setTemas, {
                ...
                <div className='grid grid-cols-4'>
                    ...
                    <div className='col-span-2'>
                        ...
                        <div className="relative ">
                            ...
                            />
                            <button onClick={BuscarTemaNome} type="submit" className="text-white absolute end-2.5 bottom-2.5 bg-blue-400
