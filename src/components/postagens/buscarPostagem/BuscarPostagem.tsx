...
function BuscarPostagem() {
    ...
    async function buscarPostagem() {
        try {
            await buscar(`/postagens/conteudo/${search}`, setPostagens, {
        ...
        <>
            <div className='py-20'>
                <div className='grid grid-cols-4'>
                    ...
                    <div className='col-span-2'>
                        ...
                        <div className="relative ">
                            ...
                            />
                            <button onClick={buscarPostagem} type="submit" className="text-white absolute end-2.5 bottom-2.5 bg-blue-400
                ...
                <div className='container mx-auto grid grid-rows-1 md:grid-rows-2 gap-4 lg:grid-rows-4 p-20 hover: bg-grid-rows-6 w-2/4'>
                    {postagens.map((posta) => (
                        <CardPostagens key={posta.id} postagem={posta} />
                    ))}
                </div>
            </div>
        </>
